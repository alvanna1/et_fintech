$(document).ready(function () {
    if ($('#videoBGStill').length) {
        var desktopVideo = ' <video style="display:none;" id="videoBG" class="videoBackground" playsinline autoplay muted loop><source src="images/header_bg.mp4" type="video/mp4"></video>';
        var desktopVideozh = ' <video style="display:none;" id="videoBG" class="videoBackground" playsinline autoplay muted loop><source src="../images/header_bg.mp4" type="video/mp4"></video>';
        ...
        if (lang === 'en') {
            ...
            $("#videoBGStill").after(desktopVideozh);
        }
