...
function logoAnimation() {
	var alogo = '<img class="alogo" src="images/logo.gif" alt="FinTech Awards 2022">';
	var alogoZh = '<img class="alogo" src="../images/logo.gif" alt="FinTech Awards 2022">';
...
function videoBackgroundajust(skyValue){
...
$(".sharetoFacebook, .sharetoLinkedin, .sharetoLine, .sharetoWhatsapp, .sharetoWeibo").click( function(){
    let share_helper = import.meta.env.VITE_SHARE_HELPER;
    let share_url = 'https://fintech.etnet.com.hk/2022/';
    let share_title = 'FinTech Awards 2022';
    let share_description = 'Stepping into the Metaverse';
    let share_body = share_title+'%0A%0A'+share_url;
    let share_call = '';
    let type = $(this).data('type');
    switch(type){
        case 'linkedin':
            share_call = 'https://www.linkedin.com/shareArticle?mini=true&url='+share_url+'&title='+share_title+'&summary='+share_description;
        case 'fb':
            share_call = share_helper+'?type='+type+'&url='+share_url;
            break;
        case 'wa':
        case 'ln':
            share_call = share_helper+'?type='+type+'&body='+share_body;
            break;
        case 'wb':
            share_call = share_helper+'?type='+type+'&url='+share_url+'&title='+share_title;
            
    }
    window.open (share_call);
});