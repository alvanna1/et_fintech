...
const Header = () => {
    ...
    const { t, i18n } = useTranslation('2022');
    const basePath = location.pathname.startsWith("/2022/zh") ? "/2022/zh" : "/2022";
    return (
                    ...
                    <div className="menuitemContainer desktop">
                        ...
                        <ul className="socialLangs">
                            ...
                            <li className="lang chinese">
                                <a href="#" onClick={(event) => LanguageSwitcher(event, i18n, navigate, location)}><span>
                                    {t("header_nav.lang_opt")}</span>
                                </a>
                            </li>
                        </ul>
                    </div>
