...
import '@/i18n/';
export const Layout2018 = () => {
    const year = '2018'; // Extract the year from the path
    ...
    useEffect(() => {
        import(`@/assets/2018/css/bootstrap.css`);
        import(`@/assets/2018/css/style.css`);
        import(`@/assets/2018/css/modal.css`);
        import(`@/assets/2018/js/custom.js`);
        loadYearResources();
    }, []);
    return (
        <div>
