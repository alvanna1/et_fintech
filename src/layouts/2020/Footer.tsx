            ...
            <footer className="text-left sponsors">
                <div className="container">
                    <div className="organizers">
                        ...
                        <div className="col-xs-12 coOrganizers">
                            ...
                            <div className="col-xs-12 col-md-10 enlarge">
                                <a href="https://www.hkstp.org/en" target="_blank">
                                    <img src={ImageDir + "images/sponsors/HKSTP.png"} alt="HKSTP" />
                                </a>
                            </div>
                        </div>
                        <div className="col-xs-12 coOrganizers">
                        ...
                        <div className="col-xs-12 col-md-10"><a href="#" target="_blank"><img src={ ImageDir +"images/sponsors/GHMGBACCTA.png" } alt="Guangdong-Hong Kong-Macao Greater Bay Area Culture, Creative and Technology Alliance"/></a><a href="#" target="_blank"><img src={ ImageDir +"images/sponsors/HKXRA.png" } alt="Hong Kong Extended Reality Association"/></a><a href="http://www.hkfec.org/" target="_blank"><img src={ ImageDir +"images/sponsors/HKFEC.png" } alt="Hong Kong Federation of E-Commerce"/></a><a href="https://www.hkgcsmb.org.hk/" target="_blank"><img src={ ImageDir +"images/sponsors/HKGCSMB.png" } alt="The Hong Kong General Chamber of Small and Medium Business"/></a><a href="#" target="_blank"><img src={ ImageDir +"images/sponsors/HKINED.png" } alt="The Hong Kong Independent Non-Executive Director Association"/></a><a href="#" target="_blank"><img src={ ImageDir +"images/sponsors/HKIM.png" } alt="Hong Kong Institute of Marketing"/></a><a href="#" target="_blank"><img src={ ImageDir +"images/sponsors/HKIECA.png" } alt="Hong Kong Internet & Ecommerce Association"/></a><a href="http://www.hkna.net/" target="_blank"><img src={ ImageDir +"images/sponsors/HKNA.png" } alt="Hong Kong Netrepremeurs Association"/></a><a href="http://www.hkrtia.org/" target="_blank"><img src={ ImageDir +"images/sponsors/RTIA.png" } alt="Hong Kong Retail Technology Industry Association Ltd"/></a><a href="http://www.hkrtia.org/" target="_blank"><img src={ ImageDir +"images/sponsors/WTIA.png" } alt="Hong Kong Wireless Technology Industry Association"/></a><a href="https://www.iab.com/" target="_blank"><img src={ ImageDir +"images/sponsors/iab.png" } alt="Interactive Advertising Bureau"/></a><a href="http://www.investhk.gov.hk/index.html" target="_blank"><img src={ ImageDir +"images/sponsors/InvestHK.png" } alt="Invest Hong Kong"/></a><a href="http://www.acmcp.org/" target="_blank"><img src={ ImageDir +"images/sponsors/TIN.png" } alt="Technology Incubation Network"/></a><a href="http://www.acmcp.org/" target="_blank"><img src={ ImageDir +"images/sponsors/ACMCP.png" } alt="The Association of Cloud and Mobile Computing Professionals"/></a></div>
            </div>
			<div className="col-xs-12 coOrganizers">
                <div className="col-xs-12 col-md-2">
                    <p>Site Disinfection / Hand Sanitising Product Sponsor</p>
                </div>
                <div className="col-xs-12 col-md-10"><img src={ ImageDir +"images/sponsors/AquaProTech.png" } alt="AquaPro+Tech"/><img src={ ImageDir +"images/sponsors/Mainetti.png" } alt="Mainetti"/></div>
            </div>
                    </div>
                </div>
            </footer>
