...
import '@/i18n/';
export const Layout2020 = () => {
    const year = '2020'; // Extract the year from the path
    ...
    const loadSVGInjectScript = async () => {
        await import(`@/assets/2020/js/svg-inject.min.js`)
        if(SVGInject){
